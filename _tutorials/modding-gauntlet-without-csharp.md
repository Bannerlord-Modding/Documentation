...
3. Now that we can see the console, we want to type the command `ui.toggle_debug_mode` to enable the live UI editing feature.
6.Any changes you make to your UIs should now update automatically in-game.
